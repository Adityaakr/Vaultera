...
const categories = ['All', 'Treasury', 'Stable Yield', 'Dynamic Lending', 'HBAR Momentum', 'Event-Driven', 'Agent Curated', 'Growth'];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Browse and allocate to tokenized vault strategies</p>
      </div>
